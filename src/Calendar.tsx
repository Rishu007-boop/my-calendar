...
const Calendar = () => {
    ...
    const getWeeksInMonth = (date: Date) => {
        ...
        // Move startDate to the first day of the week
        ...
        while (startDate.getMonth() <= month) {
            ...
            for (let i = 0; i < 7; i++) {
                ...
                if (startDate.getMonth() === month) {
                    ...
                    // Push null for days outside the current month
                    week.push(null);
                }
                startDate.setDate(startDate.getDate() + 1);
            }
    ...
    const handleDateHover = (event: React.MouseEvent<HTMLTableCellElement, MouseEvent>) => {
        const target = event.target as HTMLTableCellElement;
        target.style.transform = 'scale(1.1)';
    };

    const handleDateLeave = (event: React.MouseEvent<HTMLTableCellElement, MouseEvent>) => {
        const target = event.target as HTMLTableCellElement;
    ...
    return (
        <div className="calendar-wrapper">
            <button className={`hide-calendar-button toggle-switch ${showCalendar ? '' : 'checked'}`} onClick={handleToggle}>
